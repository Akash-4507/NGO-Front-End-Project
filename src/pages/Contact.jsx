    ...
    <>
      <div className='min-h-[45rem] flex flex-col justify-center items-center bg-gradient-to-r from-slate-700 via-sky-700 to-blue-900'>
        <div className='h-auto w-[90%] md:w-[75%] lg:w-[70%] flex flex-col md:flex-row bg-black rounded-xl shadow-2xl overflow-hidden'>
          ...
          <div className='w-full md:w-[50%] bg-cover bg-center p-12 flex flex-col justify-center items-center bg-white' style={{ backgroundImage: "url('https://example.com/event-booking.jpg')" }}>
            ...
            <p className='text-black text-2xl text-center font-light leading-relaxed max-w-md'>
              Experience seamless event planning and execution. Our team is here to help you every step of the way!
            </p>
        ...
        <div className='mt-10 flex justify-center space-x-12'>
          <a href="tel:+91 9384547684" className="group relative flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-r from-gray-800 to-gray-600 shadow-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-300">
          ...
          <a href="mailto:akashanand9790@gmail.com" className="group relative flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-r from-gray-800 to-gray-600 shadow-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-300">
          ...
          <a href="https://wa.me/9384547684" className="group relative flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-r from-gray-800 to-gray-600 shadow-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-300">
