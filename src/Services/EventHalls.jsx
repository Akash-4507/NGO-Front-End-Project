...
const EventHalls = () => {
  ...
  const serviceData = [
    { 
      ...
      rating: 4.8, 
      price: "$3000", 
      thumbnail: "https://example.com/grand-ballroom.jpg",
      description: "Elegant ballroom with a capacity of up to 500 people for weddings and corporate events.",
    ...
    { 
      ...
      rating: 4.7, 
      price: "$2500", 
      thumbnail: "https://example.com/sunset-hall.jpg",
      description: "Spacious hall with a beautiful sunset view, perfect for receptions and parties.",
  ...
  return (
    <div className="container mx-auto p-6">
      ...
      <div className="bg-gray-200 p-6 text-center rounded-md mb-6">
        <h1 className="text-3xl font-semibold mb-2">Event Hall Services</h1>
        <p className="text-gray-700">Find the perfect event hall for your next gathering.</p>
      </div>
      ...
      <div className="mb-4">
        ...
        <div className="flex space-x-4">
          <button className="bg-blue-500 text-white px-4 py-2 rounded-md">Ballroom</button>
      ...
      <div className="w-full p-4">
        <h2 className="text-xl font-semibold mb-4">Event Halls</h2>
